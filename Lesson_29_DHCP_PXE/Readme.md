...
1) Создаём каталог для файлов с конфигурацией автоматической установки
```
...
```
Файл с метаданными хранит дополнительную информацию о хосте, не будем добавлять дополнительную информацию и оставим файл пусты.
